...
#### 1. Opgave
1. Klon og åben dette projekt (https://github.com/distribuerede-systemer-2019/scaled-dis.git) på din computer (se detaljeret beskrivelse under Opgave 1 her: https://github.com/Voldemorten/simple-java-dis.)
